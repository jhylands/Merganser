...
/**
 * Screen shown on completing the game
 */
public class CompleteEndScreen implements Screen {
	...
	/**
	 * Constant text for screen title
	 */
	...
	/**
	 * Constructor for End (Game Complete) Screen Calls create() to set up
	 * resources
	 * 
	 * @param game
	...
	public void create() {
		...
		// Set BitMap Fonts to font generated by generator and parameter
		...
		// Dispose of generator as no longer needed + free memory
		generator.dispose();
	}
	...
	public void render(float delta) {
		...
		// Set menuItem to contain current score for playerDuck
		...
		titleFont.draw(sb, GAMECOMPLETE,
				(game.getScreenWidth() - (titleFont.getSpaceWidth() * GAMECOMPLETE.length())) / 2, 240);
		...
		for (int i = 0; i < menuItem.length; i++) {
			...
			menuFont.draw(sb, menuItem[i],
					(game.getScreenWidth() - (menuFont.getSpaceWidth() * menuItem[i].length())) / 2, 180 - 35 * i);
		}
	...
	public void handleInput() {
		...
		// If ENTER pressed on 'exit' item then exit the application. If go to
		// MainMenu create new game
	...
	// Below methods not needed but required by implementation of screen
	@Override
